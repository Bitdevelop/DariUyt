<?php echo $header; ?>
<link rel="stylesheet" type="text/css" href="view/stylesheet/order.css" /> 
<div id="content">
      ...
      <div id="tab-product" >
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  <td class="left"><img src="<?php echo $product['image']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;"></td>
