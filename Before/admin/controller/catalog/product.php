...
class ControllerCatalogProduct extends Controller {
	private $error = array();
  	...
  	private function getForm() {
		...
		$this->data['entry_description3'] = $this->language->get('entry_description3');
		...
		if (isset($this->request->post['image']) && file_exists(DIR_IMAGE . $this->request->post['image'])) {
			$this->data['thumb'] = $this->model_tool_image->resize($this->request->post['image'], 175, 135);
		} elseif (!empty($product_info) && $product_info['image'] && file_exists(DIR_IMAGE . $product_info['image'])) {
			$this->data['thumb'] = $this->model_tool_image->resize($product_info['image'], 175, 135);
		} else {
		...
		if (isset($this->request->post['diam'])) {
      		$this->data['diam'] = $this->request->post['diam'];
    	} elseif (!empty($product_info)) {
			$this->data['diam'] = $product_info['diam'];
		} else {
      		$this->data['diam'] = '';
    	}
		...
		if (isset($this->request->post['diam_class_id'])) {
      		$this->data['diam_class_id'] = $this->request->post['diam_class_id'];
    	} elseif (!empty($product_info)) {
      		$this->data['diam_class_id'] = $product_info['diam_class_id'];
    	} else {
      		$this->data['diam_class_id'] = $this->config->get('config_length_class_id');
		}
