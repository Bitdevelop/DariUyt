...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_csvprice'] = $this->language->get('text_csvprice');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			//[
			$this->data['csvimport'] = $this->url->link('module/csvimport', 'token=' . $this->session->data['token'], 'SSL');
			//]
			...
			$this->data['csvprice'] = $this->url->link('module/csvprice', 'token=' . $this->session->data['token'], 'SSL');
