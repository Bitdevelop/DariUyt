...
<div style="width: 680px;">
  ...
  <div>
    <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $customer; ?></p>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>№ заказа:</b> <?php echo $order_id; ?><br />
          <b>Дата заказа:</b> <?php echo $date_added; ?><br />
          <b>Способ оплаты:</b> <?php echo $payment_method; ?><br />
          <?php if ($shipping_method) { ?>
          <b>Способ доставки:</b> <?php echo $shipping_method; ?>
          <?php } ?></td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>E-mail:</b> <?php echo $email; ?><br />
          <b>Телефон:</b> <?php echo $telephone; ?><br />
          <b>IP адрес:</b> <?php echo $ip; ?><br /></td>
      </tr>
    </tbody>
  </table>
 ...
 <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $total['text']; ?>&nbsp;руб.</td>
      </tr>
      <?php } ?>
    </tfoot>
    </table>

    <p style="margin-top: 0px; margin-bottom: 20px;">Для оплаты Вашего заказа пройдите по ссылке <a href="<?php echo $link; ?>"><?php echo $title_link; ?></a></p>
    <p style="margin-top: 0px; margin-bottom: 20px;">Пройдя по ссылке,  Вы попадете на модуль платежной системы, где следуя инструкции, необходимо произвести оплату.<br/>
    Спасибо за покупку в нашем магазине!<br/>
    По всем вопросам Вы можете связаться с нами:<br/>
    тел: <?php echo $telephoneBack; ?><br/>
    эл.  почта:  <?php echo $emailBack; ?><br/>
    </p>
