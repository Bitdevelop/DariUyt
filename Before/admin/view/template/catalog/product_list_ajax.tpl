        ...
        <table class="list">
          <thead>
            <tr id="head">
              ...
              <td class="left"><?php if ($sort == 'p.model') { ?>
                ...
                <a href="<?php echo $sort_sku; ?>" class="<?php echo strtolower($order); ?>">Артикул (SKU)</a>
                <?php } else { ?>
                <a href="<?php echo $sort_sku; ?>">Артикул (SKU)</a>
                <?php } ?></td>
                <?php //] ?>
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td></td>
              <td><select name="filter_category_id" style="width:50px;">
                  <option value="*"></option>
...
product_ajax copyright &copy; <a href="mailto:ruslan.shv@gmail.com">Ruslan Shvarev</a>
