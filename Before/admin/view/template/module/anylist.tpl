        ...
        <table id="module" class="list">
          <thead>
            <tr>
              ...
              <td class="left hidden"><?php echo $entry_dimension; ?></td>
              <td class="left hidden"><?php echo $entry_limit; ?></td>
              <td class="left hidden"><?php echo $entry_layout; ?></td>
              <td class="left hidden"><?php echo $entry_position; ?></td>
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td style="vertical-align: top" class="left">
                <div class="hidden"><?php echo $entry_code; ?> <input type="text" name="anylist_module[<?php echo $module_row; ?>][code]" value="<?php echo $module['code']; ?>" /><br/>&nbsp;<br/></div>
                <div class="hidden"><?php echo $entry_titlelink ?> <input type="text" name="anylist_module[<?php echo $module_row; ?>][titlelink]" value="<?php echo $module['titlelink']; ?>" /><br/>&nbsp;<br/></div>
                <?php foreach ($languages as $language) { ?>
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Заголовок <input type="text" name="anylist_module[<?php echo $module_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo (isset($module['title'][$language['language_id']]) ? $module['title'][$language['language_id']] : ''); ?>" /><br/>
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Подзаголовок <input type="text" name="anylist_module[<?php echo $module_row; ?>][shortdesc][<?php echo $language['language_id']; ?>]" value="<?php echo (isset($module['shortdesc'][$language['language_id']]) ? $module['shortdesc'][$language['language_id']] : ''); ?>" /><br/>
                         <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Описание <textarea type="text" name="anylist_module[<?php echo $module_row; ?>][shortdesc2][<?php echo $language['language_id']; ?>]"><?php echo (isset($module['shortdesc2'][$language['language_id']]) ? $module['shortdesc2'][$language['language_id']] : ''); ?></textarea><br/>
                <?php } ?>

              </td>
              <td style="vertical-align: top" class="left">
                <div class="hidden"><br /><b><?php echo $entry_category; ?></b><br />
                <div class="scrollbox">
                  <?php $class = 'odd'; ?>
             ...
             <td style="vertical-align: top" class="left hidden"><input type="text" name="anylist_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
              ...
              <?php } ?></td>
              <td style="vertical-align: top" class="right hidden"><input type="text" name="anylist_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="3" /></td>
              <td style="vertical-align: top" class="left hidden"><select name="anylist_module[<?php echo $module_row; ?>][layout_id]" id="anylist_module_layout_<?php echo $module_row; ?>">
                <?php $limitfilter = ''; ?>
          ...
          <td style="vertical-align: top" class="left hidden"><select name="anylist_module[<?php echo $module_row; ?>][position]">
...
function addModule() {
	...
	html += '<div class="hidden"><?php echo $entry_code; ?> <input type="text" name="anylist_module['+module_row+'][code]" value="" /><br/>&nbsp;<br/></div>'
	html += '<div class="hidden"><?php echo $entry_titlelink ?> <input type="text" name="anylist_module['+module_row+'][titlelink]" value="" /><br/>&nbsp;<br/></div>';
  <?php foreach ($languages as $language) { ?>
   html += '<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Заголовок <input type="text" name="anylist_module['+module_row+'][title][<?php echo $language['language_id']; ?>]" value="" /><br/>';
   html += '<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Подзаголовок <input type="text" name="anylist_module['+module_row+'][shortdesc][<?php echo $language['language_id']; ?>]" value="" /><br/>';
     html += '<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> Описание <textarea type="text" name="anylist_module['+module_row+'][shortdesc2][<?php echo $language['language_id']; ?>]" ></textarea><br/>';
   <?php } ?>
   html += '</td>';
   html += '<td style="vertical-align: top">';
   html += '    <div class="hidden"><br/><b><?php echo $entry_category; ?></b>:';
   ...
   <?php foreach ($categories as $category) { ?>
     ...
     html += '<br/>'
     html += '    <br/></div><b><?php echo $entry_products; ?>:</b>';
     ...
     html += '   <div class="hidden"> <br/>&nbsp;<br/><b><?php echo $entry_latest_text;   ?></b>: <input size="3" type="text" name="anylyst_module['+module_row+'][latest]" value="0"/>';
     ...
     <?php foreach ($prodfields as $f) { ?>
       ...
       html += '    <td class=" hidden left"><input type="text" name="anylist_module[' + module_row + '][width]" value="80" size="3" /> <input type="text" name="anylist_module[' + module_row + '][height]" value="80" size="3" /></td>';
       html += '<td class="hidden right" style="vertical-align: top"><input type="text" name="anylist_module['+module_row+'][limit]" value="20" size="3" /></td>';
       html += '    <td class="hidden left" style="vertical-align: top"><select name="anylist_module[' + module_row + '][layout_id]" id="anylist_module_layout_'+module_row+'">';
       <?php foreach ($layouts as $layout) { ?>
         html += '      <option <?=(($layout['layout_id']=="12")?"selected":"")?> limitfilter="<?php echo $layout['filter']; ?>" id="anylist_module_layout_'+module_row+'_option_<?php echo $layout['layout_id']; ?>"  value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
         <?php } ?>
         html += '    </select>';
          ...
          <?php foreach ($categories as $category) { ?>
            ...
            <?php foreach ($manufacturers as $manufacturer) { ?>
              ...
              <?php foreach ($categories as $category) { ?>
                ...
                html += '    </td>';
                html += '    <td class="left hidden" style="vertical-align: top"><select name="anylist_module[' + module_row + '][position]">';
                ...
                html += '	<br /><?php echo $text_period; ?><br />';
