...
class ControllerProductManufacturer extends Controller {  
	public function index() { 
		...
		foreach ($results as $result) {
			...
			$this->data['categories'][$key]['manufacturer'][] = array(
				//[
				'image' => $this->model_tool_image->resize($result['image'], 58, 58),
				//]
				'name' => $result['name'],
	...
	public function info() {
		...
		if(isset($this->request->get['manufacturer_id'])) {
			$model = $this->model_catalog_product->getModels($this->request->get['manufacturer_id']);
			if ($model)
				$this->data['model_array'] = $model;
		}
...
// var_dump($this->request->get['model']);exit;
		...
		if ($manufacturer_info) {
			...
			$this->data['limits'][] = array(
				'text'  => 12,
				'value' => 12,
				'href'  => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . $url . '&limit=12')
				);
			
			$this->data['limits'][] = array(
				'text'  => 24,
				'value' => 24,
				'href'  => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . $url . '&limit=24')
				);
			$this->data['limits'][] = array(
				'text'  => 'Все',
				'value' => 1000,
