...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <a href="#tab-attribute" class="hidden"><?php echo $tab_attribute; ?></a>
      <a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <tr>
                  <td><?php echo $entry_description3; ?></td>
                  <td><textarea name="product_description[<?php echo $language['language_id']; ?>][description3]" id="description3<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description3'] : ''; ?></textarea></td>
                </tr>
				...
				<td><textarea name="product_description[<?php echo $language['language_id']; ?>][description2]" id="description2<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description2'] : ''; ?></textarea></td>
			</tr></tr>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td>Длина</td>
                      <td><input type="text" name="length" value="<?php echo $length; ?>" size="4" /></td>
                    </tr>
                    <tr>
                      <td>Ширина</td>
                      <td><input type="text" name="width" value="<?php echo $width; ?>" size="4" /></td>
                    </tr>
                    <tr>
                      <td>Высота</td>
                      <td><input type="text" name="height" value="<?php echo $height; ?>" size="4" /></td>
                    </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Диаметр:	</td>
                        <td><input type="text" name="diam" value="<?php echo $diam; ?>" /></td>
                      </tr>
                      <tr>
                        <td>Единица измерения диаметра:</td>
                        <td><select name="diam_class_id">
                          <?php foreach ($length_classes as $length_class) { ?>
                          <?php if ($length_class['length_class_id'] == $diam_class_id) { ?>
                          <option value="<?php echo $length_class['length_class_id']; ?>" selected="selected"><?php echo $length_class['title']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $length_class['length_class_id']; ?>"><?php echo $length_class['title']; ?></option>
                          <?php } ?>
...
//echo '</XMP>';
                      $attr_arr = array('1'=>array('text'=>''));
//                      $atr[14] = array('attribute_id'=>14, 'name'=>'Серия', 'product_attribute_description'=>$attr_arr);
  //                    $atr[15] = array('attribute_id'=>15, 'name'=>'Страна', 'product_attribute_description'=>$attr_arr);
                      //$atr[15] = array('attribute_id'=>15, 'name'=>'Акция', 'product_attribute_description'=>$attr_arr);
                      //foreach ($product_attributes as $attr){
    //                    unset($atr[$attr['attribute_id']]);
                      //}
...
$('#languages a').tabs();
$('#vtab-option a').tabs();
$('#description21').parents('tr').remove();
//--></script>
<?php echo $footer; ?>