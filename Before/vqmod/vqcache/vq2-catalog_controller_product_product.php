...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($path == NULL) {
			...
			$categori = $this->model_catalog_product->getCategories($product_id);
			if ($categori) {
				$this->request->get['path'] = $categori['0']['category_id'];
			}
		}
		...
		if ($product_info) {
			...
			$this->url->link('product/category').
				...
				'&model=' . str_replace(' ', '+', $product_info['model']);
...
$this->data['description2'] = html_entity_decode($product_info['description2'], ENT_QUOTES, 'UTF-8');
			...
			$this->data['description3'] = html_entity_decode($product_info['description3'], ENT_QUOTES, 'UTF-8');
