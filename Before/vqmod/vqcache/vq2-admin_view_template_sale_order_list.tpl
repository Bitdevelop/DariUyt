      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
			...
			<td class="right" style="background: #<?php echo $order['status_bg_color']; ?>; color: #<?php echo $order['status_txt_color']; ?>;">
			...
			<td class="left" style="background: #<?php echo $order['status_bg_color']; ?>; color: #<?php echo $order['status_txt_color']; ?>;">
          ...
          <tbody>
			...
			<td style="text-align: center; background: #<?php echo $order['status_bg_color']; ?>; color: #<?php echo $order['status_txt_color']; ?>;">
			...
			<td class="left" style="background: #<?php echo $order['status_bg_color']; ?>; color: #<?php echo $order['status_txt_color']; ?>;">
			<?php echo $order['date_modified']; ?></td>
