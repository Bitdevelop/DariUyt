    ...
    <body>
        <div id="container">
            <div id="header">
                ...
                <?php } ?>
                <div id="storecontacts">
                    <div id=store_phone>
                        <?php echo preg_replace('/\A(\+\d{1})(\d{3})(\d{3})(\d{2})/','$1 ($2) $3-$4-',$storephone); ?>
                    </div>
                    <div id=store_mail>
                        <?php 
                        $storemail1='<a href="mailto:'.$storemail.'">'.$storemail.'</a>';
                        preg_match_all('/.{1}/', $storemail1, $store_mail);?>
                        <script type="text/javascript">
                                <?php foreach ($store_mail[0] as $char):?>                        
                                document.write('<?php echo $char;?>');
                                <?php endforeach; ?>    
                        </script>                                        
                    </div>
                </div>
