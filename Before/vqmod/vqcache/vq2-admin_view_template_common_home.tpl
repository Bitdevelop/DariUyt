      ...
      <div class="latest">
        ...
        <div class="dashboard-content">
          <table class="list">
			...
			<td class="right" style="text-align: center; background: #<?php echo isset($order['status_bg_color']) ? $order['status_bg_color'] : ''; ?>; color: #<?php echo isset($order['status_txt_color']) ? $order['status_txt_color'] : ''; ?>;">
			<?php echo $column_order; ?></td>
                
			<td class="left" style="text-align: left; background: #<?php echo isset($order['status_bg_color']) ? $order['status_bg_color'] : ''; ?>; color: #<?php echo isset($order['status_txt_color']) ? $order['status_txt_color'] : ''; ?>;">
			...
			<td class="left" style="text-align: left; background: #<?php echo isset($order['status_bg_color']) ? $order['status_bg_color'] : ''; ?>; color: #<?php echo isset($order['status_txt_color']) ? $order['status_txt_color'] : ''; ?>;">
			<?php echo $order['customer']; ?></td>
                
			<td class="left" style="text-align: left; background: #<?php echo isset($order['status_bg_color']) ? $order['status_bg_color'] : ''; ?>; color: #<?php echo isset($order['status_txt_color']) ? $order['status_txt_color'] : ''; ?>;">
			<?php echo $order['status']; ?></td>
                
			<td class="left" style="text-align: left; background: #<?php echo isset($order['status_bg_color']) ? $order['status_bg_color'] : ''; ?>; color: #<?php echo isset($order['status_txt_color']) ? $order['status_txt_color'] : ''; ?>;">
			<?php echo $order['date_added']; ?></td>
