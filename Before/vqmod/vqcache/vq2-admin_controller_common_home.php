<?php   
			...
			mysql_query("alter table " . DB_PREFIX . "order_status add column `status_bg_color` varchar(50) charset utf8 collate utf8_unicode_ci default '' not null after `name`");
			mysql_query("alter table " . DB_PREFIX . "order_status add column `status_txt_color` varchar(50) charset utf8 collate utf8_unicode_ci default '' not null after `status_bg_color`");
