...
table.orderadress, table.orderproduct {
width: 48%;
border-collapse: collapse;
margin-bottom: 20px;
}
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div id="tab-customer">
		  ...
		  <th colspan="2"><?php echo $tab_customer; ?></th>
            <tr>
		...
		<div id="tab-product">
          <table class="list orderproduct" style="float:right;">
            <thead>
			<tr><th colspan="7"><?php echo $tab_product; ?></th></tr>
              <tr>
                <td></td>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
				...
				<td class="left"><?php if ($order_product['image'] != "") {?><img src="<?php echo $order_product['image'];?>" style="padding: 1px; border: 1px solid #DDDDDD;"><?php } ?></td>
          ...
          <table class="list orderproduct" style="float:right;clear:both;">
            <thead>
              <tr>
        ...
        <div id="tab-voucher">
          <table class="list">
            <thead>
			<tr><th colspan="6"><?php echo $tab_voucher; ?></th></tr>
              <tr>
                <td></td>
                <td class="left"><?php echo $column_product; ?></td>
                <td class="left"><?php echo $column_model; ?></td>
        ...
        <div id="tab-total">
          <table class="list">
            <thead>
			<tr><th colspan="6"><?php echo $tab_total; ?></th></tr>
              <tr>
                <td class="left"><?php echo $column_product; ?></td>
                <td class="left"><?php echo $column_model; ?></td>
                <td class="right"><?php echo $column_quantity; ?></td>
