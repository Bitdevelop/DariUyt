...
table.ordermain > tbody > tr > th, table.orderadress > tbody > tr > th, table.list > thead > tr > th, table.history  > tbody > tr > th, table.form > tbody > tr > th{
background: #115B8B;
color: #FFFFFF;
font-size: 14px;
font-weight: 700;
...
table.ordermain > tbody > tr > td{
width:25%;
}

table.ordermain > tbody > tr > td:nth-child(odd), table.orderadress > tbody > tr > td:nth-child(odd){
background:#EFEFEF
}

table.ordermain > tbody > tr > td, table.orderadress > tbody > tr > td  {
padding: 5px;
color: black;
...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
		...
		<th colspan="4"><?php echo $tab_order; ?></th>
          <tr>
          ...
          <tr>
            ...
            <td id="order-status"><?php if ($order_status) { ?><?php echo $order_status; ?><?php } ?></td>
            <td><?php echo $text_payment_method; ?></td>
            <td><?php echo $payment_method; ?></td>
          </tr>
          <tr>
            <td><?php echo $text_customer; ?></td>
            <td><?php if ($customer) { ?><a href="<?php echo $customer; ?>"><?php echo $firstname; ?> <?php echo $lastname; ?></a><?php } else { ?><?php echo $firstname; ?> <?php echo $lastname; ?><?php } ?></td>
          ...
          <tr>
            ...
            <td><?php if ($ip) { ?><?php echo $ip; ?><?php } ?></td>
          </tr>
          <tr>
            <td><?php echo $text_email; ?></td>
            <td><?php echo $email; ?></td>
			<td><?php echo $text_forwarded_ip; ?></td>
            <td><?php if ($forwarded_ip) { ?><?php echo $forwarded_ip; ?><?php } ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php if ($fax) { ?><?php echo $fax; ?><?php } ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="3"><?php if ($comment) { ?><?php echo $comment; ?><?php } ?></td>
          </tr>
        </table>
      </div>
	  <div class="clr"></div>
      <div id="tab-payment" >
        <table class="orderadress" style="float:left;">
      ...
      <div id="tab-shipping" >
        <table class="orderadress" style="float:right;">
      ...
      <div id="tab-product" >
        <table class="list">
          <thead>
            <tr><th colspan="6"><?php echo $tab_product; ?></th></tr>
			<tr>
          ...
          <tbody>
            ...
            <tr>
			  <td class="left"><?php if ($product['image'] != "") {?><img src="<?php echo $product['image'];?>" style="padding: 1px; border: 1px solid #DDDDDD;"><?php } ?></td>
	  ...
	  <div class="clr"></div>
      <div id="tab-history" >
	  <table class="history"><tr><th colspan="5"><?php echo $tab_order_history; ?></th></tr></table>
        <div id="history"></div>
        <table class="form">
          <tr>
      ...
      <div id="tab-fraud" >
        <table class="form">
		<th colspan="2"><?php echo $tab_fraud; ?></th>
